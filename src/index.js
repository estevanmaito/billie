...
;(async function () {
  ...
  function drawAlert(selector, onClick) {
    ...
    div.classList.add(`billie--alert--${_violations[selector].impact}`, 'billie--alert')
  ...
  function createTitle(violation) {
    ...
    title.innerHTML = `Accessibility ${capitalizeWord(violation.impact)} Violation`
  ...
  init().then(console.log('Billie rendered'))
})()
